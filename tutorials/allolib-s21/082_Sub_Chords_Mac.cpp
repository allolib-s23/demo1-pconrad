// Edit of Collette L.'s code from allolib-s21
// Adjustments for a Mac keyboard
// Original designed for Windows (presumably)
...
public:
    ...
    bool onKeyDown(Keyboard const &k) override
    {
        ...
        if (k.key()=='1')
        {
            ...
            major = !major;
            cout << ((major) ? "major" : "minor") << endl;
        }
        else if (k.key()=='2')
        {
            seven = !seven;
            cout << ((seven) ? "7th" : "no 7th") << endl;
        }
        else if (k.key()=='3')
        {
            // std::cout<< "chords\n";
            chords = !chords;
            cout << ((chords) ? "chords" : "notes") << endl;
        ...
        if (midiNote > 0)
        {
            ...
            if (chords)
            {
                ...
                if (major)
                {
                    ...
                    if (seven)
                        synthManager.triggerOff(midiNote + 11);
                }
                else
                {
                    synthManager.triggerOff(midiNote + 3);
                    if (seven)
                        synthManager.triggerOff(midiNote + 10);
                }
            }
        }
        return true;
...
void usage()
{
    cout << "1: Major/Minor" << endl;
    cout << "2: Seventh/No Seventh" << endl;
    cout << "3: Chords/Notes" << endl;
    cout << "4: Octave up" << endl;
    cout << "5: Octave down" << endl;
}
